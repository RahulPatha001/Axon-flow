  ...
  return (
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-6'>
            ...
            mx-auto leading-[1.2]'>Create at the Speed of Thought <br /> with
            <span className='text-primary'>AI Tools</span></h1>
            <p className='mt-4 max-w-lg 2xl:max-w-xl m-auto max-sm:text-sx text-gray-600'>Use our collection of high-end 
                AI technologies to revolutionize the way you create content. Create photographs, write articles, and improve your workflow.</p>
        </div>

        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            <button className='bg-primary text-white px-10 py-3 rounded-lg
            hover:scale-102 active:scale-95 transition cursor-pointer' onClick={()=>navigate('/ai')}> Start creating</button>
            <button className='bg-white px-10 py-3 rounded-lg border border-gray-300 *
            hover:scale-102 active:scale-95 transition cursor-pointer'>Demo</button>
        </div>
