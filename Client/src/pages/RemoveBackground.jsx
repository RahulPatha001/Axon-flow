  ...
  return (
    <div className='h-full overflow-y-scroll p-6 items-start flex flex-wrap gap-4 text-slate-700'>
      ...
      onSubmit={onSubmitHandler}>
        ...
        <p className='font-light text-gray-500 text-xs mt-2'>Supports Jpeg, png and other image formats</p>
        
        <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41]
