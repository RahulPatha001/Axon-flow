  ...
  return (
    <div className='h-full overflow-y-scroll p-6 items-start flex flex-wrap gap-4 text-slate-700'>
      ...
      onSubmit={onSubmitHandler}>
        ...
        <input type="file" className='w-full p-3 mt-2 outline-none text-sm rounded-md border border-gray-300 text-gray-600' required
        ...
        placeholder='eg: spoon, ball or any one object name' required
        onChange={(e)=>setObject(e.target.value)} value={object}/>
        
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF6]
