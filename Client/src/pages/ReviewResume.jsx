  ...
  return (
    <div className='h-full overflow-y-scroll p-6 items-start flex flex-wrap gap-4 text-slate-700'>
      ...
      onSubmit={onSubmitHandler}>
        ...
        <p className='font-light text-gray-500 text-xs mt-2'>Supports pdf format only</p>
        
        <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83]
      ...
      min-h-96 max-h-[600px]' >
        ...
        </div>
        {
         ...
         <div className='flex-1 flex justify-center items-center'>
          ...
          <p>Upload resume and click "Review Resume"</p>
          </div>

        </div>
          ) :(
            <div className='mt-3 h-full overflow-y-scroll text-sm text-slate-600'>
              <Markdown className="revert-tw">{content}</Markdown>
            </div>
          )
        }
