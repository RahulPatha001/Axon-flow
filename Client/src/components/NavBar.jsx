  ...
  return (
    <div className='fixed z-5 w-full backdrop-blur-2xl flex justify-between items-center py-3 px-4 sm:px-20 xl:px-32 cursor-pointer'>
...

        {
            ...
            : 
            (                
            <button  onClick={openSignIn} className='flex items-center gap-2 rounded-full text-sm cursor-pointer px-10
            bg-primary text-white py-2.5'>Get Started <ArrowRight className='w-4 h-4' /></button>
            )
        }
